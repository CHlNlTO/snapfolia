      ...
      <section className="flex flex-col-reverse lg:flex-row items-center justify-center gap-0 lg:gap-28 mt-2 lg:mt-20 ">
        ...
        <div className="px-6 sm:px-0">
          ...
          <motion.h3
            ...
            className="text-md sm:text-2xl font-semibold mt-2 lg:mt-6 text-green-800/70 opacity-75 text-center lg:text-left"
          >
            Upload a photo of a tree leaf to identify it
          </motion.h3>
        </div>
      </section>
