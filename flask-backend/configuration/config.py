...
class Config:
    ...
    YOLO_CLASSIFICATION_MODEL = os.path.join(os.path.dirname(__file__), 'model_files', '59_CLS.pt')
    YOLO_OBJECT_DETECTION_MODEL = os.path.join(os.path.dirname(__file__), 'model_files', '58_OBJ.pt')
